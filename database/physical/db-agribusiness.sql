...
CREATE TABLE IF NOT EXISTS inventory_items (
        ...
        property_id INT NOT NULL,
        name VARCHAR(100) NOT NULL,
        category ENUM('SEMENTES', 'FERTILIZANTES', 'DEFENSIVOS', 'RACOES', 'EQUIPAMENTOS', 'PECAS', 'PRODUTOS_QUIMICOS', 'EMBALAGENS',
        'COMBUSTIVEIS', 'OUTROS') NOT NULL DEFAULT 'OUTROS',
        unit ENUM('QUILOGRAMA', 'GRAMA', 'LITRO', 'MILILITRO', 'UNIDADE', 'CAIXA', 'SACO', 'TONELADA', 'METRO_CUBICO', 'OUTRO') NOT NULL
        DEFAULT 'OUTRO',
        quantity DECIMAL(12,2) NOT NULL DEFAULT 0,
        unit_cost DECIMAL(12,2) NOT NULL DEFAULT 0.00,
        total_cost DECIMAL(14,2) NOT NULL DEFAULT 0.00,
        status ENUM('DISPONIVEL', 'EM_FALTA', 'RESERVADO', 'BLOQUEADO', 'OBSOLETO') NOT NULL DEFAULT 'DISPONIVEL',
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS sale (
        ...
        payment_method ENUM('PIX', 'BOLETO', 'TRANSFERENCIA', 'CARTAO_DE_CREDITO', 'DINHEIRO', 'TROCA') NOT NULL DEFAULT 'DINHEIRO',
        notes TEXT,
...
CREATE TABLE IF NOT EXISTS crops (
        ...
        status ENUM('PLANTIO', 'DESENVOLVIMENTO', 'PONTO_DE_COLHEITA', 'COLHIDO', 'PERDIDO') NOT NULL DEFAULT 'PLANTIO',
        plant_date DATE,
        harvest_date DATE,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS livestock (
        ...
        health_status ENUM('SAUDAVEL', 'DOENTE', 'TRATAMENTO', 'VACINACAO_PENDENTE', 'ABATIDO', 'OBITO') NOT NULL DEFAULT 'SAUDAVEL',
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
